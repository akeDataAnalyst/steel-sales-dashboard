...
st.caption("Simulated reinforcement bar sales analysis — Ethiopian market (2020–2026 + forecast)")
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("Data: synthetic simulation inspired by Ethiopian steel sector")
...
# Footer
st.markdown("---")
st.caption("Developed by **Aklilu Abera** • Data Analytics")
